...
if __name__ == "__main__":
    ...
    midi_dir = "/Users/jonade/code/nompar/piano_ai/raw_data/2017"  # Path to your MIDI file
    out_dir = "/Users/jonade/code/nompar/piano_ai/2017_midi_targets_npz"
    ...
    for midi_path in midi_files:
        ...
        # Get the 5 targets
        onset, offset, active, velocity, pedal = midi_to_targets(midi_path, n_frames)
